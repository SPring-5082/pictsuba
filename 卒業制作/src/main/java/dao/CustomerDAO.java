...
public class CustomerDAO extends DAO {
	 ...
	 */
	public static Customer findById(int customer_id) throws SQLException, SQLDataNotFoundException{
	 ...
	 * @throws SQLDataNotFoundException 
	 */
	public static Customer findByMailandPass(String mail, String password) throws SQLException, SQLDataNotFoundException{
